...
const (
	mockTLEName  = "ISS (ZARYA)"
	mockTLELine1 = "1 25544U 98067A   24100.50000000  .00016717  00000-0  10270-3 0  9009"
	mockTLELine2 = "2 25544  51.6400 200.0000 0001234  90.0000 270.0000 15.49000000400001"
)

func TestPositionLatRange(t *testing.T) {
	pos, err := GetCurrentPosition(mockTLEName, mockTLELine1, mockTLELine2)
	if err != nil {
