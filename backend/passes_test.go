...
func TestSunAltitudeNoonHigher(t *testing.T) {
	// At the equator on an equinox, noon sun should be higher than midnight
...
func TestPassPredictions(t *testing.T) {
	preds, err := GetPassPredictions(mockTLEName, mockTLELine1, mockTLELine2, 35.6762, 139.6503, 3)
	if err != nil {
